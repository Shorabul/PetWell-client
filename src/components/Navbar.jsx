            ...
            <div className="w-11/12 flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse relative">
                    ...
                    {user ?
                        ...
                        : < Link to='/auth/login' type="button" className="focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-2 focus:ring-green-600 font-semibold rounded-lg text-sm px-5 py-2.5 mb-2">Login</Link>
                    }
                    {/* Dropdown menu bar*/}
