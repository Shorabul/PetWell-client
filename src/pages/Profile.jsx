        ...
        <>
            <div className='w-10/12 mx-auto space-y-10 md:space-y-20'>
                ...
                <div className='space-y-1 bg-[#1c1c1c] p-5 rounded-2xl text-white/50'>
                    ...
                    <div className='flex justify-between items-center gap-3 bg-[#1c1c1c] shadow-[0_0_10px_#617620] rounded-md px-5 py-4 hover:scale-102 transition-all ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-3'>
                            <FaUser className='size-5 lg:size-7' />
                            <div className='text-sm md:text-base lg:text-lg'>
                                <h3 className='text-white/90'>Title &#47; Name</h3>
                                <p className=''>{user?.displayName || "Anonymous User"}</p>
                            </div>
                        </div>
                        <Link
                            type='button'
                            ...
                            to='/update-name'
                            className="font-medium py-1.5 px-4 rounded-sm transition-all duration-300 flex items-center gap-1 text-white bg-[#2a2a2a] hover:bg-[#a1c935] focus:bg-[#c1e340] shadow-[0_0_10px_#8bbf2a]">
                            <MdModeEdit /> Edit
                        </Link>
                    ...
                    <div className='flex justify-between items-center gap-3 bg-[#1c1c1c] shadow-[0_0_10px_#617620] rounded-md px-5 py-4 hover:scale-102 transition-all ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-3'>
                            ...
                            <div className='text-sm md:text-base lg:text-lg'>
                                ...
                                <p className=''>{user?.email || "Anonymous User"}</p>
                            </div>
                        </div>
                        <Link
                            type='button'
                    ...
                    <div className="pt-6">
                        <Link
                            to="/update-profile"
                            className="inline-flex items-center gap-2 bg-[#1c1c1c] focus:bg-[#a1c935] hover:bg-[#a1c935] shadow-[0_0_10px_#617620] text-white font-semibold px-5 sm:px-6 py-2.5 rounded-lg transition-all duration-200 hover:scale-[1.02]"
                        >
